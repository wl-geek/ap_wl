...
<section class="home">
    ...
    <p class="myP" data-aos="fade-right">Please login/sign up to ask questions!</p>
...
<div class="container" data-aos="fade-left">
    ...
    <section class=" py-5 text-white mt-5" style="font-size:15px; background-color:black; overflow:hidden;">
